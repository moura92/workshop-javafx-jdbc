...
public class MainViewController implements Initializable {
	...
	private synchronized void loadView(String absolutName) { // synchronized garante que o processamento não seja
																// interrompido.
		try {
	...
	private synchronized void loadView2(String absolutName) { // synchronized garante que o processamento não seja
		// interrompido.
		try {
			FXMLLoader loader = new FXMLLoader(getClass().getResource(absolutName));
			VBox newVBox = loader.load();
